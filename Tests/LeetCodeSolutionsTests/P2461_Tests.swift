...
final class P2461_Solution1_Tests: XCTestCase {
    ...
    func testExample2() {
        ...
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
        XCTAssertEqual(result, expected, "The maximum sum for nums = [4,4,4], k = 3 should be 0 as there are no valid subarrays.")
    }
    ...
    func testMaxSumAtTheBeginning() {
        ...
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
        XCTAssertEqual(result, expected, "The valid subarray [1,2,3] at the beginning should produce the maximum sum of 6.")
    }
    ...
    func testKEqualsArrayLengthWithDuplicateElements() {
        ...
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
        XCTAssertEqual(result, expected, "The entire array is not a valid subarray due to duplicates, result should be 0.")
    }
    ...
    func testComplexCaseWithSomeValidSubarrays() {
        ...
        let k = 3
        let expected: Int64 = 10 // Subarray [4,1,5]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testValidSubarrayAtBeginningFollowedByDuplicates() {
        ...
        let nums = [5,3,1,1,1]
        let k = 2
        let expected: Int64 = 8 // Subarray [5,3]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testIncreasingNumbersAllSubarraysValid() {
        ...
        let k = 2
        let expected: Int64 = 11000 // Subarray [1000, 10000]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testDecreasingNumbersAllSubarraysValid() {
        ...
        let k = 2
        let expected: Int64 = 11000 // Subarray [10000, 1000]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testIntermediateValidSubarray() {
        ...
        let k = 4
        let expected: Int64 = 21 // Subarray [2,7,4,8]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testOverlappingNumbersBetweenWindows() {
        ...
        let k = 3
        let expected: Int64 = 70 // Subarray [10,20,40]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testSimpleIncreasingSequence() {
        ...
        let nums = [1,2,3,4,5]
        let k = 2
        let expected: Int64 = 9 // Subarray [4,5]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testSimpleDecreasingSequence() {
        ...
        let nums = [5,4,3,2,1]
        let k = 2
        let expected: Int64 = 9 // Subarray [5,4]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
        XCTAssertEqual(result, expected, "For a simple decreasing sequence, the first subarray should have the max sum.")
    }
    ...
    func testRepeatingPattern() {
        ...
        let k = 3
        let expected: Int64 = 9 // Subarray [2,3,4]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testAValidSubarrayAfterManyDuplicates() {
        ...
        let k = 4
        let expected: Int64 = 10 // Subarray [4,1,2,3]
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")
    ...
    func testLargeNumbers() {
        let s = P2461_Solution1()
        let nums = [100000, 99999, 99998]
        let k = 3
        let expected: Int64 = 299997
        let result = s.maximumSubarraySum(nums, k)
        print("Test Case: \(#function), Input: nums = \(nums), k = \(k), Expected: \(expected), Result: \(result)")

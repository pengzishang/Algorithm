...
final class P2134_Solution1_Tests: XCTestCase {
    ...
    func testLargeArrayAllOnes() {
        let nums = Array(repeating: 1, count: 100000)
        let result = s.minSwaps(nums)
    ...
    func testLargeArrayAllZeros() {
        let nums = Array(repeating: 0, count: 100000)
        let result = s.minSwaps(nums)
    ...
    func testLargeArrayOneZero() {
        var nums = Array(repeating: 1, count: 100000)
        nums[50000] = 0
        let result = s.minSwaps(nums)
    ...
    func testLargeArrayOneOne() {
        var nums = Array(repeating: 0, count: 100000)
        nums[50000] = 1
        let result = s.minSwaps(nums)

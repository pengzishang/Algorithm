...
final class P1423_Solution1_Tests: XCTestCase {
    ...
    func testAlternatingHighValues() {
        ...
        XCTAssertEqual(result, 400, "Should take all high value cards")
    }
    ...
    func testLargeArrayPerformance() {
        let cardPoints = Array(repeating: 1, count: 100000)
        let k = 50000
        let result = solution.maxScore(cardPoints, k)
    ...
    func testMixedValuesOptimalSplit() {
        ...
        XCTAssertEqual(result, 18, "Optimal split between left and right")
    }
    ...
    func testRandomMixedValues() {
        ...
        XCTAssertEqual(result, 28, "Random mixed values test")
    }

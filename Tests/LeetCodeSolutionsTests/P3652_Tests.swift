...
final class P3652_Solution1_Tests: XCTestCase {
    ...
    func testAllBuyOperations() {
        ...
        XCTAssertEqual(result, -10, "Expected profit of -10 with all buys, modification should improve")
    }
    ...
    func testAllHoldOperations() {
        ...
        XCTAssertEqual(result, 0, "Expected profit of 0 with all holds")
    }
    ...
    func testMixedOperationsK4() {
        ...
        XCTAssertEqual(result, 9, "Expected profit of 9 with optimal modification")
    }
    ...
    func testKEqualToArrayLength() {
        ...
        XCTAssertEqual(result, 60, "Expected profit of 60 by modifying entire array")
    }
    ...
    func testHighProfitModification() {
        ...
        XCTAssertEqual(result, 100, "Expected profit of 100 from optimal modification")
    }
    ...
    func testMultiplePossibleModifications() {
        ...
        XCTAssertEqual(result, 18, "Expected profit of 18 from best modification")
    }
    ...
    func testIncreasingPrices() {
        ...
        XCTAssertEqual(result, 40, "Expected profit of 40 with optimal modification")
    }
    ...
    func testRandomMixedOperations() {
        ...
        XCTAssertEqual(result, 11, "Expected profit of 11 with optimal modification")
    }
    ...
    func testMaximumPrices() {
        let s = P3652_Solution1()
        let prices = [100000, 100000, 100000]
        let strategy = [-1, -1, -1]
        let k = 2
        let result = s.maxProfit(prices, strategy, k)
        print("Test 15 - Prices: \(prices), Strategy: \(strategy), k: \(k), Result: \(result)")
        XCTAssertEqual(result, 100000, "Expected profit of 100000 with modification")
    }
    ...
    func testLargeDatasetPerformance() {
        ...
        XCTAssertTrue(result >= -1000000000 && result <= 1000000000, "Result should be within reasonable range")
    }
    ...
    func testOptimalModificationInMiddle() {
        ...
        XCTAssertEqual(result, 198, "Expected profit of 198 from middle modification")
    }
    ...
    func testMixedWithZerosDominant() {
        ...
        XCTAssertEqual(result, 40, "Expected profit of 40 with original strategy")
    }
    ...
    func testK2WithAlternatingOperations() {
        ...
        XCTAssertEqual(result, 18, "Expected profit of 18 with optimal modification")
    }

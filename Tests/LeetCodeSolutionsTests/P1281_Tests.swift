...
final class P1281_Solution1_Tests: XCTestCase {
    ...
    func testMaximumValue() {
        let s = P1281_Solution1()
        let result = s.subtractProductAndSum(100000)
    ...
    func testAllDigitsSame() {
        ...
        XCTAssertEqual(result, 315, "777的各位积(343)与和(21)之差应为315")
    }
    ...
    func testLargeNumber() {
        ...
        XCTAssertEqual(result, 15120, "98765的各位积(15120)与和(35)之差应为15120")
    }

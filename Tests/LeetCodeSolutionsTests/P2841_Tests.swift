...
final class P2841_Solution1_Tests: XCTestCase {
    ...
    func testLargeNumbers_14() {
        ...
        let m = 3
        let k = 3
        let expected = 2_000_000_000 // [1_000_000_000, 999_999_999, 1]
        let result = s.maxSum(nums, m, k)
        print(result)
        XCTAssertEqual(result, expected, "Failed for nums: \(nums), m: \(m), k: \(k)")
    }
    ...
    func testMCloseToK_16() {
        ...
        let m = 3
        let k = 4
        let expected = 9 // [3,1,2,3] and [3,1,2,3]
        let result = s.maxSum(nums, m, k)
        print(result)
        XCTAssertEqual(result, expected, "Failed for nums: \(nums), m: \(m), k: \(k)")
    }
    ...
    func testKIsSmall_21() {
        ...
        let m = 2
        let k = 2
        let expected = 1100 // [100,1000] and [1000,100]
        let result = s.maxSum(nums, m, k)
        print(result)
        XCTAssertEqual(result, expected, "Failed for nums: \(nums), m: \(m), k: \(k)")
    }
    ...
    func testPerformance_LargeArrayIncreasing_25() {
        ...
        let m = 5000
        let k = 10000
        let expected = 150_005_000 // Sum of [10001, ..., 20000]
        let result = s.maxSum(nums, m, k)
        print(result)
...
final class P2841_Solution2_Tests: XCTestCase {
    func testExample_1() {
        // LeetCode 示例 1
        // LeetCode Example 1
        let s = P2841_Solution2()
        let nums = [2, 6, 7, 3, 1, 7]
        let m = 3
        let k = 4
        let expected = 18
